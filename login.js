...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Manejar envío del formulario. La función es asíncrona para poder
    // esperar la carga de usuarios desde Supabase cuando está configurado.
    loginForm.addEventListener('submit', async e => {
        ...
        try {
            ...
            // Si falla la carga asíncrona, intentar la carga sincrónica como fallback
            users = loadUsers();
        }
